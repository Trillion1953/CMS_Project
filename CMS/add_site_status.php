...
try {
	if (isset($_POST["submit"])) {
		...
		if (
			empty($_POST["site_ID"]) || empty($_POST["status_ID"])
		) {
			...
			// $query = "INSERT INTO site_status_mapping (site_ID,status_ID) 
			// 				  VALUES ('$st','$ft')";
			// $query_run = mysqli_query($con, $query);

			$sql = "UPDATE site_master SET status_ID='$ft' WHERE ID='$st'";
			$sql_run = $conn->prepare($sql);
			$sql_exec = $sql_run->execute(array("status_ID" => $ft));

			// $query1 = "INSERT INTO site_status_mapping (site_ID,status_ID) 
			// 			  VALUES ('$st','$it')";
...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>SRUJAN CONSTRUCTION</title>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					<li class="dropdown">
						<a href="index1.php" class="dropdown-toggle no-arrow">
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Add Status</h4>
					...
					<form method="post" action="add_site_status.php">
						<!-- <div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-6 col-sm-6 ">
								<select id="inputState" class="custom-select2 form-control" name="status_ID">
									<option selected="">Choose...</option>
									<?php
									include 'config.php';
									$sql = "SELECT ID,NAME FROM view_status_master where STATUS='Enable'";
