...
$result = $conn->prepare("SELECT * FROM view_user_master WHERE ID=$id");
$result->execute();
...
if (isset($_POST['update'])) {
	if (($_POST['USER_NAME'] == "") ||  ($_POST['USER_STATUS'] == "") ||  ($_POST['ADDRESS'] == "") ||  ($_POST['ROLE_ID'] == "")) {
		...
		$sql = "UPDATE user_master SET USER_NAME='$USER_NAME',USER_STATUS='$USER_STATUS',ADDRESS='$ADDRESS',MOBILE_NO1='$MOBILE_NO1',MOBILE_NO2='$MOBILE_NO2',ROLE_ID='$ROLE_ID' WHERE ID='$id'";
		$sql_run = $conn->prepare($sql);
		$sql_exec = $sql_run->execute(array("USER_NAME" => $USER_NAME, "USER_STATUS" => $USER_STATUS, "ADDRESS" => $ADDRESS, "MOBILE_NO1" => $MOBILE_NO1, "MOBILE_NO2" => $MOBILE_NO2, "ROLE_ID" => $ROLE_ID));
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page"><a href="index1.php">User List</a></li>
								</ol>
							</nav>
						</div>
					...
					<form method="post">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-2">
								<input class="form-control" type="text" name="MOBILE_NO1" value="<?php echo $MOBILE_NO1; ?>">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-2">
								<input class="form-control" type="text" name="MOBILE_NO2" value="<?php echo $MOBILE_NO2; ?>">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-16 col-sm-2">
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-4 col-sm-2 ">
								...
								<select id="inputState" class="form-control " name="ROLE_ID">
									<?php
									echo "<option selected=''>$ROLE_NAME1</option>";


									include 'config.php';
									$sql = "SELECT ID,role_NAME FROM view_role_master where ID='$ROLE_ID'";
									...
									if ($result) {
										...
										while ($row = $result->fetch(PDO::FETCH_OBJ)) {
											...
											echo "<option selected value='$row->ID'> $row->role_NAME ";
											echo "</option>";
										}
									}
									?>
						...
						<input class="btn btn-primary btn-lg" type="submit" name="update" id="submit" value="Update">
