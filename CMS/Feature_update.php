...
$result = $conn->prepare("SELECT * FROM feature_master WHERE ID=$id");
$result->execute();
...
if (isset($_POST['update'])) {
	if (($_POST['feature_NAME'] == "") ||  ($_POST['feature_STATUS'] == "")) {
		echo "fill all records";
	} else {

		$feature_NAME1 = $_POST['feature_NAME'];
		$feature_STATUS1 = $_POST['feature_STATUS'];



		$sql = "UPDATE feature_master SET feature_NAME='$feature_NAME1',feature_STATUS='$feature_STATUS1' WHERE ID='$id'";
		$sql_run = $conn->prepare($sql);
		$sql_exec = $sql_run->execute(array("feature_NAME" => $feature_NAME1, "feature_STATUS" => $feature_STATUS1));
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post">
						<div class="form-group row">
							<label class="col-sm-12 col-md-1 col-form-label">Feature</label>
							<div class="col-sm-6 col-md-3">
								<input class="form-control" type="text" placeholder="Enter Feature name" name="feature_NAME" value="<?php echo $feature_NAME; ?>">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-16 col-sm-16">
								...
								<select id="inputState" class="form-control" name="feature_STATUS">
									<option selected=""><?php echo $feature_STATUS; ?></option>
