...
try {
	if (isset($_POST["submit"])) {
		if (
			empty($_POST["USER_NAME"]) || empty($_POST["ADDRESS"])
			|| empty($_POST["ROLE_ID"]) || empty($_POST["USER_STATUS"])
		) {
			$msg = "all fields are required";
		} else {


			$query = "INSERT INTO user_master (USER_NAME,USER_STATUS,ADDRESS,MOBILE_NO1,MOBILE_NO2,ROLE_ID,CATE_TYPE) 
				VALUES (:USER_NAME,:USER_STATUS,:ADDRESS,:MOBILE_NO1,:MOBILE_NO2,:ROLE_ID,:CATE_TYPE)";
			$stmt = $conn->prepare($query);
			$stmt = $stmt->execute(

				array(
					'USER_NAME' => $_POST["USER_NAME"], 'USER_STATUS' => $_POST["USER_STATUS"],

					'ADDRESS' => $_POST["ADDRESS"], 'MOBILE_NO1' => $_POST["MOBILE_NO1"],

					'MOBILE_NO2' => $_POST["MOBILE_NO2"], 'ROLE_ID' => $_POST["ROLE_ID"],
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="Dash_user.php">User List</a></li>
					...
					<form method="post" action="add_user.php">
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-4">
								<input class="form-control" type="text" placeholder="Enter User Name" name="USER_NAME">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-3">
								<div class="veri">
									<input class="form-control" placeholder="Enter Mobile No" type="text" name="MOBILE_NO1" maxlength="10" pattern="\d{10}">
								</div>
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Alt. Mobile No.</label>
							<div class="col-sm-8 col-md-3">
								<input class="form-control" placeholder="Enter Alt. Mobile No" type="text" name="MOBILE_NO2" maxlength="10" pattern="\d{10}">
							</div>
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-4 col-sm-4 ">
								<select id="inputState" class="form-control " name="ROLE_ID">
									...
									<?php
									include 'config.php';
									$sql = "SELECT ID,role_NAME FROM view_role_master where role_STATUS='Enable'";
									...
									if ($result) {
										...
										while ($row = $result->fetch(PDO::FETCH_OBJ)) {
											...
											echo "<option value='$row->ID'> $row->role_NAME ";
											echo "</option>";
										}
									}
									?>
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">LABOUR / SUPPLIER</label>

							<div class="form-group col-md-16 col-sm-16">
								<h6>Dont select for Client Registration</h6>

								<select id="inputState" class="form-control" name="CATE_TYPE">
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">USER_STATUS</label>
							<div class="form-group col-md-16 col-sm-16">
						...
						<div class="pull-right">
							...
							<a href="Dash_user.php" class="btn btn-primary btn-sm scroll-click " rel="content-y" class="btn-block">Back</a>
