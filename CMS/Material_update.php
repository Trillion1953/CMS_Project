...
if (isset($_SESSION["Uname"])) {
	echo '<h6> login success, Welcome -' . $_SESSION["Uname"] . '</h6>';
} else {
...
$result = $conn->prepare("SELECT * FROM material_master WHERE ID=$id");
$result->execute();
...
if (isset($_POST['update'])) {
	if (($_POST['material_NAME'] == "") ||  ($_POST['material_STATUS'] == "")) {
		echo "fill all records";
	} else {

		$material_NAME1 = $_POST['material_NAME'];
		$material_STATUS1 = $_POST['material_STATUS'];



		$sql = "UPDATE material_master SET material_NAME='$material_NAME1',material_STATUS='$material_STATUS1' WHERE ID='$id'";
		$sql_run = $conn->prepare($sql);
		$sql_exec = $sql_run->execute(array("material_NAME" => $material_NAME1, "material_STATUS" => $material_STATUS1));

		header("location: Dash_material.php");
	}
}
?>
...
<body>
			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<?php
						echo '<h6> Admin : ' . $_SESSION["Uname"] . '</h6>';
						?>
	...
	<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.html">
				<label class="label">Srujan Construction</label>
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="Dash_material.php">Material List</a></li>
				...
				<div class="pd-20 card-box mb-30">
					...
					<form method="post">
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="Enter Material name" name="material_NAME" value="<?php echo $material_NAME; ?>">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-16 col-sm-16">
								...
								<select id="inputState" class="form-control" name="material_STATUS">
									<option selected=""><?php echo $material_STATUS; ?></option>
						...
						<div class="pull-right">
							...
							<a href="Dash_material.php" class="btn btn-primary btn-sm scroll-click " rel="content-y" class="btn-block">Back</a>
