...
$result = $conn->prepare("SELECT * FROM role_master WHERE ID=$id");
$result->execute();
...
if (isset($_POST['update'])) {
	if (($_POST['role_NAME'] == "") ||  ($_POST['role_STATUS'] == "")) {
		echo "fill all records";
	} else {

		$role_NAME1 = $_POST['role_NAME'];
		$role_STATUS1 = $_POST['role_STATUS'];



		$sql = "UPDATE role_master SET role_NAME='$role_NAME1',role_STATUS='$role_STATUS1' WHERE ID='$id'";
		$sql_run = $conn->prepare($sql);
		$sql_exec = $sql_run->execute(array("role_NAME" => $role_NAME1, "role_STATUS" => $role_STATUS1));

		header("location: Dash_role.php");
	}
}
?>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="Dash_role.php">Role List</a></li>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4"> Role details</h4>
					...
					<form method="post">
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="Enter Bank name" name="role_NAME" value="<?php echo $role_NAME; ?>">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-16 col-sm-16">
								...
								<select id="inputState" class="form-control" name="role_STATUS">
									<option selected=""><?php echo $role_STATUS; ?></option>
						...
						<div class="pull-right">
							...
							<a href="Dash_role.php" class="btn btn-primary btn-sm scroll-click " rel="content-y" class="btn-block">Back</a>
