				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						...
						<div class="pull-right">
							<a href="add_user.php" class="btn btn-primary btn-sm scroll-click" rel="content-y">ADD</a>
					...
					<?php
					include 'config.php';
					$sql = "SELECT ID,role_NAME,USER_NAME,USER_STATUS FROM view_user_master";
					...
					if ($result) {
						...
						while ($row = $result->fetch(PDO::FETCH_OBJ)) {
							echo 	"<tr>
											...
											<td><a href='User_view.php?PID=$row->ID'><big><i class='icon-copy fa fa-eye' aria-hidden='true'></i><big></a></td>
											<td><a href='User_update.php?PID=$row->ID'><big><i class='icon-copy fa fa-pencil-square-o' aria-hidden='true'</i><big></a></td>
