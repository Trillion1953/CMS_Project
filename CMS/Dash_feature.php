			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">Feature List</h4>
							<!-- <p>Add class <code>.table</code></p> -->
						</div>
						<div class="pull-right">
							<a href="add_feature.php" class="btn btn-primary btn-sm scroll-click" rel="content-y">ADD</a>
						</div>
					</div>

					<?php
					include 'config.php';
					$sql = "SELECT ID,feature_NAME,feature_STATUS FROM feature_master";
					...
					if ($result) {
						...
						while ($row = $result->fetch(PDO::FETCH_OBJ)) {
							echo 	"<tr>
											...
											<td>$row->feature_STATUS</td> 
										

											
											<td><a href='Feature_update.php?PID=$row->ID'><big><i class='icon-copy fa fa-pencil-square-o' aria-hidden='true'</i><big></a></td>
