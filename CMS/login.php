...
try {
	...
	if (isset($_POST["submit"])) {
		if (empty($_POST["USER_NAME"]) || empty($_POST["USER_PSW"])) {
			...
			$query = "SELECT * FROM user_master WHERE USER_NAME = :USER_NAME AND USER_PSW = :USER_PSW AND USER_STATUS='Enable'";
			$statement = $conn->prepare($query);
			$statement->execute(array('USER_NAME' => $_POST['USER_NAME'], 'USER_PSW' => $_POST['USER_PSW']));
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h1 class="text-center text-primary">CMS</h1>
						...
						<form method="POST">
							...
							<div class="input-group custom">
								<input type="text" class="form-control form-control-lg" placeholder="Username" name="USER_NAME">
							...
							<div class="input-group custom">
								<input type="password" class="form-control form-control-lg" placeholder="**********" name="USER_PSW">
								<div class="input-group-append custom">
