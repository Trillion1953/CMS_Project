...
try {
	if (isset($_POST["submit"])) {
		if (
			empty($_POST["client_ID"]) || empty($_POST["site_ID"]) || empty($_POST["RUPEES"]) || empty($_POST["CREATED_DATE_TIME"])
			|| empty($_POST["REMARK"]) || empty($_POST["pay_MODE"])
		) {
			$msg = "all fields are required";
		} else {


			$query = "INSERT INTO payment_master(client_ID,site_ID,RUPEES,CREATED_DATE_TIME,REMARK,pay_MODE) 
				VALUES (:client_ID,:site_ID,:RUPEES,:CREATED_DATE_TIME,:REMARK,:pay_MODE)";
			$stmt = $conn->prepare($query);
			$stmt = $stmt->execute(

				array(
					'client_ID' => $_POST["client_ID"], 'site_ID' => $_POST["site_ID"],

					'RUPEES' => $_POST["RUPEES"], 'CREATED_DATE_TIME' => $_POST["CREATED_DATE_TIME"],

					'REMARK' => $_POST["REMARK"], 'pay_MODE' => $_POST["pay_MODE"]

				)
			);
			header("location: Dash_payment.php");
		}
	}
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="Dash_payment.php">Payment List</a></li>
					...
					<form method="post" action="add_payment.php">
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-16 col-sm-16">
								...
								<select id="inputState" class="form-control" name="pay_MODE">
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-4 col-sm-4 ">
								<select id="inputState" class="form-control " name="client_ID">
									...
									<?php
									include 'config.php';
									$sql = "SELECT ID,USER_NAME,role_NAME FROM view_user_master where USER_STATUS='Enable'";
									$result = $conn->query($sql);
									...
									if ($result) {
										...
										while ($row = $result->fetch(PDO::FETCH_OBJ)) {
											...
											echo "<option value='$row->ID'> $row->USER_NAME ($row->role_NAME)";
											echo "</option>";
										}
									}
									?>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-3">
								<input class="form-control" placeholder="Enter Total Rs" type="number" name="RUPEES">
							</div>
						</div>
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label"></label>
							<div class="col-sm-12 col-md-3">
								<input class="form-control date-picker" type="text" placeholder="Select Date" name="CREATED_DATE_TIME">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-4">
								<input class="form-control" type="text" placeholder="Enter Remark" name="REMARK">
							</div>
						</div>
						...
						<div class="pull-right">
							...
							<a href="Dash_payment.php" class="btn btn-primary btn-sm scroll-click " rel="content-y" class="btn-block">Back</a>
