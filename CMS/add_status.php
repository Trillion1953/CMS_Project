...
try {
	if (isset($_POST["submit1"])) {
		if (empty($_POST["status_NAME"]) || empty($_POST["status_STATUS"])) {
			$msg = "all fields are required";
		} else {


			$query = "INSERT INTO status_master (status_NAME,status_STATUS) VALUES (:status_NAME,:status_STATUS)";
			...
			$msg = "Data Added..";
			header("location: Dash_status.php");
		}
	}
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="Dash_status.php">Status List</a></li>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Enter Status details</h4>
							<!-- <p class="mb-30">All bootstrap element classies</p> -->
						</div><br>
						<div class="pull-right">
							<!-- <a href="#basic-form1" class="btn btn-primary btn-sm scroll-click" rel="content-y"
								data-toggle="collapse" status="button"><i class="fa fa-code"></i> Source Code</a> -->
						</div><br><br>
					</div>
					...
					<form method="post" action="add_status.php">
						<div class="form-group row">
							...
							<div class="col-md-3">
								<input class="form-control" type="text" placeholder="Enter status name" name="status_NAME">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Status</label>
							<div class="form-group col-md-16 col-sm-16">
								...
								<select id="inputState" class="form-control" name="status_STATUS">
						...
						<div class="pull-right">
							...
							<a href="Dash_status.php" class="btn btn-primary btn-sm scroll-click " rel="content-y" class="btn-block">Back</a>
						...
						<div class="code-box">
							<div class="clearfix">
								...
								<a href="#basic-form1" class="btn btn-primary btn-sm pull-right" rel="content-y"
									data-toggle="collapse" status="button"><i class="fa fa-eye-slash"></i> Hide Code</a>
							</div>
			...
			<input class="form-control" value="50" type="range">
					...
					<!-- <div class="pull-right">
							<a href="#horizontal-basic-form1" class="btn btn-primary btn-sm scroll-click"
								rel="content-y" data-toggle="collapse" status="button"><i class="fa fa-code"></i> Source
								Code</a>
						</div>
					</div> -->
					<!-- <form>
						...
						<div class="code-box">
							<div class="clearfix">
								...
								<a href="#horizontal-basic-form1" class="btn btn-primary btn-sm pull-right"
									rel="content-y" data-toggle="collapse" status="button"><i class="fa fa-eye-slash"></i>
									Hide Code</a>
							</div>
