...
try {
	if (isset($_POST["submit1"])) {
		if (empty($_POST["feature_NAME"]) || empty($_POST["feature_STATUS"])) {
			$msg = "all fields are required";
		} else {


			$query = "INSERT INTO feature_master (feature_NAME,feature_STATUS) VALUES (:feature_NAME,:feature_STATUS)";
			...
			$msg = "Data Added..";
			header("location: Dash_feature.php");
		}
	}
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="Dash_feature.php">Feature List</a></li>
									<li class="breadcrumb-item"><a href="add_site_feature.php">Add SiteFeature</a></li>
									<li class="breadcrumb-item active" aria-current="page">Add Master Feature</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Add feature</h4>
							<!-- <p class="mb-30">All bootstrap element classies</p> -->
						</div><br>
						<div class="pull-right">
							<!-- <a href="#basic-form1" class="btn btn-primary btn-sm scroll-click" rel="content-y"
								data-toggle="collapse" feature="button"><i class="fa fa-code"></i> Source Code</a> -->
						</div><br><br>
					</div>

					<form method="post" action="add_feature.php">
						<div class="form-group row">
							<label class="col-sm-6 col-md-1 col-form-label">Feature</label>
							<div class="col-md-3">
								<input class="form-control" type="text" placeholder="Enter feature name" name="feature_NAME">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="form-group col-md-16 col-sm-16">
								...
								<select id="inputState" class="form-control" name="feature_STATUS">
						...
						<input class="btn btn-primary btn-lg mr-5" type="submit" name="submit1" id="submit" value="Submit">

						<span class="loginMsg"><?php echo @$msg; ?></span>

						<div class="pull-right">

							<a href="Dash_feature.php" class="btn btn-primary btn-sm scroll-click " rel="content-y" class="btn-block">Back</a>
						...
						<div class="code-box">
							<div class="clearfix">
								...
								<a href="#basic-form1" class="btn btn-primary btn-sm pull-right" rel="content-y"
									data-toggle="collapse" feature="button"><i class="fa fa-eye-slash"></i> Hide Code</a>
							</div>
			...
			<input class="form-control" value="50" type="range">
					...
					<!-- <div class="pull-right">
							<a href="#horizontal-basic-form1" class="btn btn-primary btn-sm scroll-click"
								rel="content-y" data-toggle="collapse" feature="button"><i class="fa fa-code"></i> Source
								Code</a>
						</div>
					</div> -->
					<!-- <form>
						...
						<div class="code-box">
							<div class="clearfix">
								...
								<a href="#horizontal-basic-form1" class="btn btn-primary btn-sm pull-right"
									rel="content-y" data-toggle="collapse" feature="button"><i class="fa fa-eye-slash"></i>
									Hide Code</a>
							</div>
