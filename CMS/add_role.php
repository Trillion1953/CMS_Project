...
try {
	if (isset($_POST["submit1"])) {
		if (empty($_POST["role_NAME"]) || empty($_POST["role_STATUS"])) {
			$msg = "all fields are required";
		} else {


			$query = "INSERT INTO role_master (role_NAME,role_STATUS) VALUES (:role_NAME,:role_STATUS)";
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Enter role details</h4>
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-16 col-sm-16">
								...
								<select id="inputState" class="form-control" name="role_STATUS">
									...
									<option value="Enable" name="enable">Enable</option>
