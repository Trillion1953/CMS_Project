				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						...
						<div class="pull-right">
							<a href="add_role
							.php" class="btn btn-primary btn-sm scroll-click" rel="content-y">ADD</a>
						</div>
					</div>
					...
					<?php
					include 'config.php';
					$sql = "SELECT ID,role_NAME,role_STATUS FROM role_master";
					...
					if ($result) {
						...
						while ($row = $result->fetch(PDO::FETCH_OBJ)) {
							echo 	"<tr>
											...
											<td><a href='Role_update.php?PID=$row->ID'><big><i class='icon-copy fa fa-pencil-square-o' aria-hidden='true'</i><big></a></td>
