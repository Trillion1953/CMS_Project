...
try {
	if (isset($_POST["submit"])) {
		...
		if (
			empty($_POST["site_ID"]) || empty($_POST["feat_ID"])
		) {
			...
			foreach ($ft as $it) {
				...
				$query = "INSERT INTO site_feature_mapping (site_ID,feat_ID) 
							  VALUES ('$st','$it')";
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Add Features</h4>
					...
					<form method="post" action="add_site_feature.php">
						...
						<div class="pull-right">
							...
							<a href="Dash_site.php" class="btn btn-primary btn-sm scroll-click " rel="content-y" class="btn-block">Back</a>
