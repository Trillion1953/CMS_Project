...
try {
	if (isset($_POST["submit"])) {
		if (empty($_POST["site_ID"]) || empty($_POST["feat_ID"])) {
			$msg = "all fields are required";
		} else {


			$query = "INSERT INTO site_feature_mapping (site_ID,feat_ID) VALUES (:site_ID,:feat_ID)";
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="Dash_site.php">Site List </a></li>
									<li class="breadcrumb-item"><a href="add_feature.php">Add Master Feature</a></li>
									<li class="breadcrumb-item active" aria-current="page">Add Site Feature</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Add Site Features</h4>
					...
					<form method="post" action="add_site_feature.php">
						<!-- <div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">NAME</label>
							<div class="col-sm-12 col-md-4">
								<input class="form-control" type="text" placeholder="Enter site Name" name="site_NAME">
							</div>
						</div> -->
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">SITE</label>
							<div class="form-group col-md-4 col-sm-4 ">
								<select id="inputState" class="form-control " name="site_ID">
									<option selected="">Choose...</option>
									<?php
									include 'config.php';
									$sql = "SELECT ID,site_NAME FROM view_site_master where STATUS='Enable'";
									$result = $conn->query($sql);
									if ($result) {
										while ($row = $result->fetch(PDO::FETCH_OBJ)) {
											echo "<option value='$row->ID'> $row->site_NAME ";
											echo "</option>";
										}
									}
									?>
						...
						<!-- <div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">SITE STATUS</label>
							<div class="form-group col-md-4 col-sm-4 ">
								<select id="inputState" class="form-control " name="site_STATUSID">
									<option selected="">Choose...</option>
									<?php
									// include 'config.php';
									// $sql = "SELECT ID,NAME FROM view_status_master where STATUS='Enable'";
									// $result = $conn->query($sql);
									// if ($result) {
									// 	while ($row = $result->fetch(PDO::FETCH_OBJ)) {
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-6 col-sm-6 " name="features">
								<select id="inputState" class="custom-select2 form-control" multiple name="feat_ID[]">

									<?php
									include 'config.php';
									$sql = "SELECT ID,NAME FROM view_feature_master where STATUS='Enable'";
									$result = $conn->query($sql);
									if ($result) {
										while ($row = $result->fetch(PDO::FETCH_OBJ)) {
											echo "<option name='optfeature' value='$row->ID'> $row->NAME ";
											echo "</option>";
										}
									}
									?>
						...
						<!-- <div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">MATERIALS</label>
							<div class="form-group col-md-6 col-sm-6">
								<select id="inputState" class="selectpicker form-control" data-size="5" data-style="btn-outline-secondary" multiple data-max-options="3" name="site_MATERIALID[]">

									<?php
									// include 'config.php';
									// $sql = "SELECT ID,NAME FROM view_material_master where STATUS='Enable'";
									// $result = $conn->query($sql);
									// if ($result) {
									// 	while ($row = $result->fetch(PDO::FETCH_OBJ)) {
									// 		echo "<option value='$row->ID'> $row->NAME ";
						...
						<!-- <div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">SITE DESCRIPTION</label>
							<div class="col-sm-12 col-md-6">
								<input class="form-control" placeholder="Enter site description" type="text" name="site_DESC">
							</div>
						</div> -->
						<!-- 
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">STATUS</label>
							<div class="form-group col-md-16 col-sm-16">
						...
						<input class="btn btn-primary btn-lg mr-5" type="submit" name="submit" id="submit" value="Submit">

						<span class="loginMsg"><?php echo @$msg; ?></span>

						<div class="pull-right">

							<a href="index1.php" class="btn btn-primary btn-sm scroll-click " rel="content-y" class="btn-block">Back</a>
