...
try {
	if (isset($_POST["submit1"])) {
		if (empty($_POST["material_NAME"]) || empty($_POST["material_STATUS"])) {
			$msg = "all fields are required";
		} else {


			$query = "INSERT INTO material_master (material_NAME,material_STATUS) VALUES (:material_NAME,:material_STATUS)";
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Addf material</h4>
							<!-- <p class="mb-30">All bootstrap element classies</p> -->
						</div><br>
						<div class="pull-right">
							<!-- <a href="#basic-form1" class="btn btn-primary btn-sm scroll-click" rel="content-y"
								data-toggle="collapse" material="button"><i class="fa fa-code"></i> Source Code</a> -->
						</div><br><br>
					</div>

					<form method="post" action="add_material.php">
						<div class="form-group row">
							<label class="col-sm-12 col-md-1 col-form-label">Material</label>
							<div class="col-md-3">
								<input class="form-control" type="text" placeholder="Enter material name" name="material_NAME">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="code-box">
							<div class="clearfix">
								...
								<a href="#basic-form1" class="btn btn-primary btn-sm pull-right" rel="content-y"
									data-toggle="collapse" material="button"><i class="fa fa-eye-slash"></i> Hide Code</a>
							</div>
			...
			<input class="form-control" value="50" type="range">
					...
					<!-- <div class="pull-right">
							<a href="#horizontal-basic-form1" class="btn btn-primary btn-sm scroll-click"
								rel="content-y" data-toggle="collapse" material="button"><i class="fa fa-code"></i> Source
								Code</a>
						</div>
					</div> -->
					<!-- <form>
						...
						<div class="code-box">
							<div class="clearfix">
								...
								<a href="#horizontal-basic-form1" class="btn btn-primary btn-sm pull-right"
									rel="content-y" data-toggle="collapse" material="button"><i class="fa fa-eye-slash"></i>
									Hide Code</a>
							</div>
