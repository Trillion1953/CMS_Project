...
<body>
	...
	<div class="header">
		...
		<div class="header-right">
			<!-- <div class="dashboard-setting site-notification">
				<div class="dropdown"> -->
			...
			<div class="min-height-200px">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index1.php">Back</a></li>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">Site List</h4>
							<!-- <p>Add class <code>.table</code></p> -->
						</div>
						<div class="pull-right">
							<a href="add_site.php" class="btn btn-primary btn-sm scroll-click" rel="content-y">ADD</a>
					...
					<?php
					include 'config.php';
					$sql = "SELECT ID,site_NAME,STATUS,status_NAME,USER_NAME FROM view_site_master";
					...
					if ($result) {
						...
						while ($row = $result->fetch(PDO::FETCH_OBJ)) {
							echo 	"<tr>
											...
											<td><a href='bills_view.php?PID=$row->ID'><big><i class='icon-copy fa fa-exchange' aria-hidden='true'></i><big></a></td>
											<td><a href='activity_view.php?PID=$row->ID'><big><i class='icon-copy fa fa-list' aria-hidden='true'></i><big></a></td>
											<td><a href='site_view.php?PID=$row->ID'><big><i class='icon-copy fa fa-eye' aria-hidden='true'></i><big></a></td>
											<td><a href='Site_update.php?PID=$row->ID'><big><i class='icon-copy fa fa-pencil-square-o' aria-hidden='true'</i><big></a></td>
