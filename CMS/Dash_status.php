				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						...
						<div class="pull-right">
							<a href="add_status.php" class="btn btn-primary btn-sm scroll-click" rel="content-y">ADD</a>
						</div>
					</div>

					<?php
					include 'config.php';
					$sql = "SELECT ID,status_NAME,status_STATUS FROM status_master";
					...
					if ($result) {
						...
						while ($row = $result->fetch(PDO::FETCH_OBJ)) {
							echo 	"<tr>
											...
											<td>$row->status_STATUS</td> 
										

											
											<td><a href='status_update.php?PID=$row->ID'><big><i class='icon-copy fa fa-pencil-square-o' aria-hidden='true'</i><big></a></td>
