...
try {
	if (isset($_POST["submit"])) {
		...
		if (
			empty($_POST["site_ID"]) || empty($_POST["material_ID"])
		) {
			$msg = "all fields are required";
		} else {

			$ft = $_POST['material_ID'];
			$st = $_POST['site_ID'];

			foreach ($ft as $it) {

				$query = "INSERT INTO site_material_mapping (site_ID,material_ID) 
							  VALUES ('$st','$it')";
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Add Materials</h4>
					...
					<form method="post" action="add_site_material.php">
						<!-- <div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-6 col-sm-6 ">
								<select id="inputState" class="custom-select2 form-control" multiple name="material_ID[]">
