...
try {
	if (isset($_POST["submit"])) {
		if (
			empty($_POST["site_NAME"]) || empty($_POST["site_DESC"]) || empty($_POST["site_USERID"])
			||  empty($_POST["STATUS"])
		) {
			...
			$query = "INSERT INTO site_master (site_NAME,STATUS,site_DESC,site_USERID) 
				VALUES (:site_NAME,:STATUS,:site_DESC,:site_USERID)";
			$stmt = $conn->prepare($query);
			$stmt = $stmt->execute(

				array(
					'site_NAME' => $_POST["site_NAME"], 'STATUS' => $_POST["STATUS"],

					'site_DESC' => $_POST["site_DESC"], 'site_USERID' => $_POST["site_USERID"]
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Site Registration</h4>
					...
					<form method="post" action="add_site.php">
						...
						<div class="form-group row">
							...
							<div class="form-group col-md-4 col-sm-4 ">
								<select id="inputState" class="form-control " name="site_USERID">
									<option selected="">Choose...</option>

									<?php
									include 'config.php';
									$sql = "SELECT ID,USER_NAME FROM view_user_master where role_NAME='Client' AND USER_STATUS='Enable'";
									...
									if ($result) {
										...
										while ($row = $result->fetch(PDO::FETCH_OBJ)) {
											...
											echo "<option value='$row->ID'> $row->USER_NAME ";
											echo "</option>";
										}
									}
									?>
